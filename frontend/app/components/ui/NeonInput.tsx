...
export const NeonInput = forwardRef<HTMLInputElement, NeonInputProps>(
  ({ className = '', error, ...props }, ref) => {
    return (
      <input
        ref={ref}
        className={`w-full px-4 py-3 bg-black/40 backdrop-blur-md border rounded-2xl text-center font-black tracking-[0.15em] text-[var(--accent)] placeholder-white/20 outline-none transition-all duration-300 ${className} ${
          error
