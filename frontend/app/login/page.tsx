        ...
        {user ? (
          ...
          <div className="flex flex-col items-center gap-4 w-full pt-2">
            <a
              ...
              className="w-full py-3.5 bg-[#5865F2] hover:bg-[#4752C4] hover:shadow-lg hover:shadow-[#5865F2]/25 text-foreground font-bold text-xs uppercase tracking-wider rounded-xl transition-all flex items-center justify-center gap-3 cursor-pointer border border-transparent hover:border-white/10"
            >
