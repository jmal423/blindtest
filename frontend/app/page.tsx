        ...
        <div className="hidden lg:flex sticky top-0 self-stretch w-full flex items-center justify-center order-last lg:order-first">
          ...
          >
            ...
            <div className="text-center">
              <p className="text-[var(--discord)] font-black text-sm uppercase tracking-wider">{t('join_discord')}</p>
              <p className="text-[var(--discord)]/60 text-[10px] font-semibold mt-1">{t('discord_desc')}</p>
            </div>
