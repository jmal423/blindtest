  ...
  return (
    <div className="relative w-60 h-60 md:w-72 md:h-72 flex items-center justify-center">
      ...
      >
        ...
        {/* Center label (spinning disk center) */}
    ...
    return (
      <div className="flex-1 flex items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-zinc-400 text-sm font-medium animate-pulse">Entering Lobbies...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="flex-1 max-w-sm w-full space-y-6">
          <div className="text-center lg:text-left space-y-3">
            <h1 className="text-5xl lg:text-6xl font-black tracking-tight leading-none uppercase">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--primary)] to-[var(--accent)] drop-shadow-[0_2px_10px_rgba(108,92,231,0.2)]">Blind</span>
          ...
          <div className="bg-white/[0.01] backdrop-blur-xl rounded-3xl border border-white/5 p-8 space-y-6 shadow-2xl relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[var(--primary)] to-[var(--accent)]" />
            <p className="text-xs text-zinc-400 font-bold tracking-wide uppercase text-center lg:text-left">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="flex items-center justify-center gap-3 w-full px-6 py-4 bg-[#5865F2] hover:bg-[#4752C4] text-white font-black text-sm rounded-2xl transition-all shadow-lg shadow-[#5865F2]/20 cursor-pointer"
            >
            ...
            <div className="flex-1 flex flex-col justify-between gap-4">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  placeholder="CODE"
                  maxLength={4}
                  className="flex-1 px-4 py-3 bg-zinc-950/50 border border-white/5 rounded-2xl text-center text-lg font-black tracking-[0.2em] text-[var(--accent)] placeholder-zinc-800 focus:outline-none focus:border-[var(--accent)] focus:ring-1 focus:ring-[var(--accent)]/30 transition-all uppercase"
                />
                <button
                  onClick={handleJoin}
                  disabled={loading || !joinCode.trim()}
                  className="px-6 py-3 bg-white/5 hover:bg-white/10 disabled:opacity-50 text-zinc-300 hover:text-white font-bold rounded-2xl border border-white/5 transition-all text-xs cursor-pointer active:scale-[0.99]"
                >
